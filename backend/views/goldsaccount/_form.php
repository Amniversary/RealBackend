...
<div class="user-form">
    ...
    <div class="form-group field-goldsaccount-gold_account_balance has-success">
        <label class="control-label" for="goldsaccount-gold_account_balance">当前冲值金额</label>
        <input type="text" id="goldsaccount-gold_account_balance" class="form-control" name="GoldsAccount[gold_account_balance_add]" >

        <div class="help-block"></div>
    </div>

    <div class="form-group">
        <?= Html::submitButton('充值', ['class' => $model->isNewRecord ? 'btn btn-success' : 'btn btn-primary']) ?>
        &nbsp;&nbsp;&nbsp;&nbsp;
