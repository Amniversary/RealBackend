...
$gridColumns = [
    ...
    [
        ...
        'urlCreator'=>function($action, $model, $key, $index){
            ...
            switch ($action){
                case 'update':
                    $url = '/sign/update?key_id='.strval($model->key_id);
                    break;
                case 'delete':
...
echo GridView::widget([
    ...
    'toolbar'=> [
        [
            'content'=> Html::button('添加关键词',['type'=>'button', 'class'=>'btn btn-success', 'onclick'=>'location="'.\Yii::$app->urlManager->createUrl('sign/create').'";return false;']),
        ],
