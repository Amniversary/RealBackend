...
<div class="user-form">
    ...
    <div class="form-group field-user-pic1 <?=($model->getFirstError('pic_url') === null?'has-success':'has-error')?>">
        ...
        <input type="hidden" name="Gift[pic]" id="user_pic" value="<?=$model->pic?>"/>
    ...
    <?= $form->field($model, 'gift_value')->textInput() ?>
    <?= $form->field($model, 'special_effects')->textInput() ?>
    <?= $form->field($model, 'world_gift')->dropDownList(['1'=>'否','2'=>'是']) ?>
    <?= $form->field($model, 'lucky_gift')->dropDownList(['0'=>'否','1'=>'是']) ?>
    ...
    <div class="form-group">
        ...
        &nbsp;&nbsp;&nbsp;&nbsp;
        <?= Html::a('取消',\Yii::$app->urlManager->createUrl(['gift/index','page' => $page]), ['class' => $model->isNewRecord ? 'btn btn-success' : 'btn btn-primary']) ?>
    </div>
