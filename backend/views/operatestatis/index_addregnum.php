...
<div class="user-form">
    ...
    <div class="top">
        <div class="col">
            ...
            <div class="font-pd"><?= array_sum($AddregnumDate['one_house_AddregnumDate']['data']) ?></div>
        </div>
        <div class="col">
            <div class="client-no bg-black ft-white">昨日</div>
            <div class="font-pd"><?= array_sum($AddregnumDate['yesterday_house_AddregnumDate']['data'])  ?></div>
        </div>
        <div class="col">
            <div class="nick-name bg-black ft-white">近三天</div>
            <div class="font-pd"><?= array_sum($AddregnumDate['three_AddregnumDate']['data'])  ?></div>
        </div>
        <div class="col">
            <div class="nick-name bg-black ft-white">近七天</div>
            <div class="font-pd"><?= array_sum($AddregnumDate['seven_AddregnumDate']['data'])  ?></div>
        </div>
        <div class="col">
            <div class="nick-name bg-black ft-white">近三十天</div>
            <div class="font-pd"><?= array_sum($AddregnumDate['thirty_AddregnumDate']['data'])  ?></div>
        </div>
    </div>
...
<select class="select-reg select">
    <option value="reg">今日/昨日</option>
    <option value="reg_three">近三天</option>
    <option value="reg_seven">近七天</option>
    <option value="reg_thirty">近三十天</option>
</select>
...
<script>
    ...
    $(".select-reg").change(function(){
        switch($(".select-reg option:selected").val())
        {
            case 'reg':
                $('#w0').show();
                $('#w1,#w2,#w3').hide();
    ...
    $('body').on('click','.download',function(){
        ...
        $('.download').attr('download',"新增注册人数数据"+download);
    });
...
//            'height' => 300,
        ...
        'series' => [$AddregnumDate['one_house_AddregnumDate'],$AddregnumDate['yesterday_house_AddregnumDate']],
        'credits'=>[
            'enabled'=>false
        ],
    ]
...
//            'height' => 300,
        ...
        'series' => [
            $AddregnumDate['three_AddregnumDate']
        ],
        'credits'=>[
            'enabled'=>false
        ],
...
//            'height' => 300,
        ...
        'series' => [$AddregnumDate['seven_AddregnumDate']],
        'credits'=>[
            'enabled'=>false
        ],
    ]
...
//            'height' => 300,
        ...
        'series' => [
            $AddregnumDate['thirty_AddregnumDate']
        ],
        'credits'=>[
            'enabled'=>false
        ],
