...
/* @var $model common\models\LaterImage */
...
<div class="user-form">
    ...
    <div class="form-group field-user-pic1 <?=($model->getFirstError('pic_url') === null?'has-success':'has-error')?>">
        ...
        <input type="hidden" name="LaterImage[pic_url]" id="user_pic" value="<?=$model->pic_url ?>"/>
    ...
    <div class="form-group">
        ...
        &nbsp;&nbsp;&nbsp;&nbsp;
        <?= Html::a('取消',\Yii::$app->urlManager->createUrl(['laterimage/index_msg', 'id'=>$id]), ['class' => $model->isNewRecord ? 'btn btn-success' : 'btn btn-primary']) ?>
    </div>
    <?php ActiveForm::end(); ?>
</div>
<?php
