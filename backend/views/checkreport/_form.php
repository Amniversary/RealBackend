...
?>
    ...
    <div class="form-group check-button-list">
        <?= Html::button('审核' , ['class' =>'btn btn-success check-refuse','id'=>'btn_refuse']).'&nbsp;&nbsp;'.Html::button('取消' , ['data-dismiss'=>'modal','aria-hidden'=>'true','class' =>'btn btn-success'])
        ?>
    </div>
    <div class="user-info">
        <p>审核备注</p>
    ...
    <div class="relate-contain">
        ...
        <textarea id="refused_reason" class="refused-reason textarea"><?= $model['remark3'] ?></textarea>
    </div>
    <div class="user-info">
        <p>相关信息</p>
    </div>
