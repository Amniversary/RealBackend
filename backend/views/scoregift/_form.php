...
<div class="user-form">
    ...
    <?= $form->field($model, 'gift_id')->dropDownList(\frontend\business\GiftUtil::GetGiftScoreType()) ?>
    ...
    <div class="form-group">
        ...
        &nbsp;&nbsp;&nbsp;&nbsp;
        <?= Html::a('取消',\Yii::$app->urlManager->createUrl(['scoregift/gift_score_index']), ['class' => $model->isNewRecord ? 'btn btn-success' : 'btn btn-primary']) ?>
    </div>
