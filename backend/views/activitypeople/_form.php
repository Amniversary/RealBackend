...
<div class="user-form">
    ...
    <?= $form->field($model, 'activity_id')->dropDownList(\familyend\business\ActivityUtil::GetActivityType()) ?>

    <?= $form->field($model, 'living_master_id')->textInput() ?>


    <div class="form-group">
        <?= Html::submitButton($model->isNewRecord ? '新增' : '修改', ['class' => $model->isNewRecord ? 'btn btn-success' : 'btn btn-primary']) ?>
        &nbsp;&nbsp;&nbsp;&nbsp;
        <?= Html::a('取消',\Yii::$app->urlManager->createUrl(['activitypeople/index']), ['class' => $model->isNewRecord ? 'btn btn-success' : 'btn btn-primary']) ?>
    </div>
