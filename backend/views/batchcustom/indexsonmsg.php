...
echo GridView::widget([
    ...
    'toolbar'=> [
        [
            'content'=>Html::button('返回',['type'=>'button','class'=>'btn btn-success','onclick'=>'location="'.\Yii::$app->urlManager->createUrl(['batchcustom/indexson','menu_id'=>$parent_id,'id'=>$id]).'";return false;']).
                Html::button('添加回复消息',['id'=>'cry-msg','type'=>'button','title'=>'添加回复', 'class'=>'btn btn-success','onclick'=>'location="'.\Yii::$app->urlManager->createUrl(['batchcustom/createsonmsg','menu_id'=>$menu_id,'parent_id'=>$parent_id,'id'=>$id]).'";return false;']),
        ],
