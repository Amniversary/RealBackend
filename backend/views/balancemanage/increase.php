...
$gridColumns = [
    ...
    [
        ...
        'buttons'=>[
            ...
            {
                return Html::a('增加余额','#',['class'=>'balance-modify','data-url'=>"$url",'data-toggle'=>"modal",'data-target'=>"#multi-modal"]);
            },
        ],
    ],
];
...
echo Html::radio('OperateType',true,['id'=>'charge_type','value'=>'1']).Html::label('增加实际豆','charge_type',['class'=>'check-item']);
echo '<br/>';
echo Html::radio('OperateType',false,['id'=>'add_money','value'=>'3']).Html::label('增加虚拟豆','add_money',['class'=>'check-item']);
echo '<br/>';
echo Html::radio('OperateType',true,['id'=>'add_ticket','value'=>'5']).Html::label('增加可提现票数','add_ticket',['class'=>'check-item']);
echo '<br/>';
echo '<br/>';
