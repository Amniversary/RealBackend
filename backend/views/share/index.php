...
$gridColumns = [
    ...
    [
        ...
        {
            return [
                'formOptions'=>['action'=>'/share/setstatus?view_id='.strval($model->view_id)],
                'size'=>'sm',
    ...
    [
        ...
        'urlCreator' => function($action, $model, $key, $index)
        {
            ...
            {
                case 'update':
                    $url = '/share/update?view_id='.strval($model->view_id);
                    break;
                case 'delete':
                    $url = '/share/delete?view_id='.strval($model->view_id);
                    break;
            }
            return $url;
        },
...
echo GridView::widget([
    ...
    'toolbar'=> [
//        [
            'content'=> Html::button($add_title,['type'=>'button','title'=>$add_title, 'class'=>'btn btn-success', 'onclick'=>'location="'.\Yii::$app->urlManager->createUrl('share/create').'";return false;']),
//        ],
        '{export}',
        '{toggleData}',
