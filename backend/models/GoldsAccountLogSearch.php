 ...
 */
class GoldsAccountLogSearch extends GoldsAccountLog
{
    /**
     * @inheritdoc
     */
    ...
    public function search($params){  
        $query = GoldsAccountLog::find()
                ->where('operate_type in(1,2,3,4,5,6) and gold_account_id ='.$params['gold_account_id'])->orderBy('create_time desc')->orderBy('log_id desc');
