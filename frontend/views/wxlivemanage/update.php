...
<div id="login">
    <form  method="post" action="/wxlivemanage/update" >
        <div class="form">
            <input  id="openid" type="hidden"  name="openid" value="<?=$openid?>" >
            <input  id="unionid" type="hidden"  name="unionid" value="<?=$unionid?>" >
            <div class="ipt-box">
                <input type="number" class="ipt" name="client_no" value="<?=$model->client_no?>" pattern="[0-9]" placeholder="请输入蜜播ID" id="j_id">
                <span class="tip">请输入蜜播ID</span>
            </div>
            <div class="ipt-box">
                <input type="text" class="ipt" name="name" value="<?=$model->name;?>" placeholder="请输入姓名" id="j_id">
                <span class="tip">请输入姓名<?=$openid?>-s</span>
            </div>
            <input type="submit" value="提交" class="btn-yellow" id="j_submit">
        </div>
    </form>
</div>
