 ...
 */
class ZhiBoEnterRoom implements IApiExcute
{
...
//\Yii::getLogger()->log(var_export($dataProtocal, true),Logger::LEVEL_ERROR);
        ...
        //开始计算经验或处理上次的经验
        if(!ChatGroupUtil::EnterRoom($living_id,$user_id,$deviceType,$owner,$error,0,$is_police))
        {
            return false;
        }
        ...
        $rstData['data']=['owner'=>$owner,'is_attention'=>$error,'system_msg'=>$sysMsg,'is_police'=>$is_police];
