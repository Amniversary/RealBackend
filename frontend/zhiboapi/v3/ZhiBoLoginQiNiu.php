            ...
            if($registerType == 1)//是不是手机登录注册
            {
                ...
                if(!empty($vCode))
                {
                    ...
                    if(!isset($ac))
                    {
                        ...
                        if(isset($deviceNoInfo))
                        {
                            \Yii::getLogger()->log('device_no1:'.$deviceNo.' unique_no:'.$uniqueNo,Logger::LEVEL_ERROR);
                            $error = '该设备已经被禁用，不能注册';
                            return false;
                        }
                        ...
                        //注册信息
                        if(!ClientUtil::RegisterUserQiNiu($uniqueNo,$deviceNo,$data,$getTuiId,$error,false,true)){
                            return false;
                        }
