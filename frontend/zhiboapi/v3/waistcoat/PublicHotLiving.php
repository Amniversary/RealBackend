...
class PublicHotLiving implements IExcute
{
    function action($dataProtocal, &$rstData,&$error, $extendData= array())
    {
        ...
        else
        {
            ...
            foreach($rst as &$oneLiving)
            {
                ...
                $guess_conf_array_count_values = array_count_values($guess_conf_array);
                $guess_living_conf_no = intval(isset($guess_conf_array_count_values[0]) ? $guess_conf_array_count_values[0] : null);
