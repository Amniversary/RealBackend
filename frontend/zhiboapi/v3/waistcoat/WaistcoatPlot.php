...
namespace frontend\zhiboapi\v3\waistcoat;
...
class WaistcoatPlot
{
    ...
    public function DoAction(){
        ...
        $configFile = __DIR__.'/WaistcoatConfig.php';// \Yii::$app->getBasePath().'/zhiboapi/v3/waistcoat/';
        ...
        {
            $rstOut['errmsg'] = '找不到对应的处理类';
            \Yii::getLogger()->log('v3找不到对应的处理类:'.$className,Logger::LEVEL_ERROR);
            echo json_encode($rstOut);
            exit;
        }

        $actionClass = 'frontend\zhiboapi\v3\waistcoat\\'.$funData[$className];
