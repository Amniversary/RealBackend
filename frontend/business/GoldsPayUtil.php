...
class GoldsPayUtil
{
     ...
     * @param $params
     * @param $pay_type
     * @param $pay_target   充值 prestore
     * @param $outParams 返回支付参数
     * @param $error
     */
    public static function GetGoldPayParams($params,$pay_type,$pay_target,&$outParams,&$error){
        ...
        //\Yii::getLogger()->log('wxpaytttttttttttttttt:ttttyyyyyyyy', Logger::LEVEL_ERROR);
        if(!class_exists($dealClass))
        {
            \Yii::getLogger()->log('wxpaytttttttttttttttt:788678686868', Logger::LEVEL_ERROR);
            $error = '对应处理类不存在';
            \Yii::getLogger()->log($error. ' '.$dealClass, Logger::LEVEL_ERROR);
            return false;
        }
        //\Yii::getLogger()->log('wxpaytttttttttttttttt:12313213', Logger::LEVEL_ERROR);
        ...
        //\Yii::getLogger()->log('wxpaytttttttttttttttt:'.var_export($params,true), Logger::LEVEL_ERROR);
     ...
     * @return bool
     */
    public static function DealGoldPayResult($params,$pay_type,$pay_target,&$error)
    {
     ...
     * @param $error
     */
    public static function CancelPrestoreByGoldPay($params,$pay_type,$pay_target,&$error)
    {
