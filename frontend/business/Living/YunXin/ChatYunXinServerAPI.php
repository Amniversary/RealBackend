 ...
 * 
***/
use frontend\business\Living\YunXin;

class ChatYunXinServerAPI
{
    private $AppKey='f0db27b7aabe1b086a608746eb7166e4';                //开发者平台分配的AppKey
    private $AppSecret='2c08e80dcd3e';             //开发者平台分配的AppSecret,可刷新
