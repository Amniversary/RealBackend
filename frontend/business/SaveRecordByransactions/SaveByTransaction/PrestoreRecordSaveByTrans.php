...
class PrestoreRecordSaveByTrans implements ISaveForTransaction
{
    private  $goldsPrestoreModel = null;
    ...
    {
        $this->goldsPrestoreModel = $record;
        $this->extend_params = $extend_params;
    }
    function SaveRecordForTransaction(&$error,&$outInfo)
    {
        if(!($this->goldsPrestoreModel instanceof GoldsPrestore ))
        {
            $error = '不是充值记录对象';
            return false;
        }
        ...
        $rst =\Yii::$app->db->createCommand($sql,[
            ...
            ':rid'=>$this->goldsPrestoreModel->prestore_id,
