...
class GoldsAccountRecordSaveByTrans implements ISaveForTransaction
{
    ...
    function SaveRecordForTransaction(&$error,&$outInfo)
    {
        ...
        $sql = 'update mb_golds_prestore set other_pay_bill=:ord, status_result=2, remark1=:nn where recharge_id=:rid and status_result = 1';
