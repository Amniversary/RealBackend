 ...
 * 用户送礼物实际豆处理
 */
class TicketMyMoneyTrans  implements ISaveForTransaction
{
    private  $params;
    private  $balance;
    ...
    public function SaveRecordForTransaction(&$error,&$outInfo)
    {
        ...
        $sql = 'update mb_balance set bean_balance=bean_balance-:gvalue ,send_ticket_count=send_ticket_count+:gvalue2,
 sign=MD5(
                  CONCAT(
 ...
 where user_id=:uid and bean_balance >= :gvalue3';//实际
