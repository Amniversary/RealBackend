...
class GetWxpayParamsForPrestore implements IGetGoldPayParams
{
    ...
    {   
        ...
        //检测参数
        //\Yii::getLogger()->log('wxpaytttttttttttttttt:lllllllllllllllllllllllllllll',Logger::LEVEL_ERROR);
        ...
        //\Yii::getLogger()->log('wxpaytttttttttttttttt:hhhhhhhhhhhhhhhhhhhh',Logger::LEVEL_ERROR);
        ...
        //\Yii::getLogger()->log('wxpaytttttttttttttttt:'.$unique_op_no,Logger::LEVEL_ERROR);
        ...
        {
            $error = '该商品不存在';
            \Yii::getLogger()->log('wxpaytttttttttttttttt:'.$error,Logger::LEVEL_ERROR);
            return false;
        }
        //\Yii::getLogger()->log('wxpaytttttttttttttttt:getparamsbefore',Logger::LEVEL_ERROR);
        ...
        //\Yii::getLogger()->log('wxpaytttttttttttttttt'.var_export($input,true),Logger::LEVEL_ERROR);
