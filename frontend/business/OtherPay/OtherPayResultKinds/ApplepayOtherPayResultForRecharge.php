...
class ApplepayOtherPayResultForRecharge implements IOtherPayResult
{
    public function DoOtherPayResult($params, &$error)
    {
        ...
        {
            \Yii::getLogger()->log('pay_money:'.$chargeInfo->pay_money.' :total_fee'.$params['total_fee'],Logger::LEVEL_ERROR);
            $error = '支付金额不匹配';
            return false;
        }
