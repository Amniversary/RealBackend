...
$llpay_config['oid_partner'] = '201601071000671903';

$llpay_config['notify_url']='http://'.$_SERVER['HTTP_HOST'].'/llpay/llpay_notify';
...
//安全检验码，以数字和字母组成的字符
$llpay_config['key'] = '938asfaslf87214JHGASLDFiuer923';
...
$llpay_config['valid_order'] ="30";//分钟有效
