<?php
namespace common\components\oss\lib\requestcore;
/**
...
class RequestCore
{
	 ...
	 */
	public $request_class = 'common\components\oss\lib\requestcore\RequestCore';

	/**
	 * The default class to use for HTTP Responses (defaults to <ResponseCore>).
	 */
	public $response_class = 'common\components\oss\lib\requestcore\ResponseCore';
